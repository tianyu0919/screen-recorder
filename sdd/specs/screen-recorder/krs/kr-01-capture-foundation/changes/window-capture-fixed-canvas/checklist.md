...
- [x] 点击波纹在已验证的 macOS Retina 窗口移动/缩放后落在实际点击区域（2026-08-25）。
- [x] macOS 圆角窗口启用任意背景色后，预览四角透出该背景色且无黑色角边（2026-08-25）。
- [ ] macOS 圆角窗口导出 MP4 后，四角同样透出所选背景色且无黑色角边。
...
- [x] macOS：Retina 下重新录制窗口，会话包含 windowGeometry，点击波纹与实际点击区域重合（`rec-1787631927800-bcakk3`，2026-08-25）。
