...
- [ ] 离开录制页、隐藏/关闭主窗口、退出应用时无边框残留。
- [ ] 目标显示器拔出时边框销毁；分辨率或缩放变化时边框 bounds 正确更新。
...
- [x] macOS 双显示器人工冒烟通过。
- [ ] Windows 双显示器人工冒烟通过，或在交付说明中明确列为待验证。
